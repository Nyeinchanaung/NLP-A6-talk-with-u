...
#     outputs = model.generate(**inputs, max_length=100, temperature=0.3, do_sample=True)
...
#     # Retrieve relevant documents
#     retrieved_docs = vector_store.similarity_search(user_query, k=2)
#     retrieved_texts = ''.join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:200] for doc in retrieved_docs]).join([doc.page_content[:200] for doc in retrieved_docs[:2]]).join([doc.page_content[:250] for doc in retrieved_docs]).join([doc.page_content[:250] for doc in retrieved_docs]).join([doc.page_content[:250] for doc in retrieved_docs]).join([doc.page_content[:250] for doc in retrieved_docs]).join([doc.page_content[:250] for doc in retrieved_docs]).join([doc.page_content for doc in retrieved_docs])  # Extract relevant text
